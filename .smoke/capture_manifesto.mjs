...
async function capture() {
  ...
  await pageDesk.screenshot({ path: '.smoke/manifesto_desktop.png', fullPage: true })
  console.log('Saved .smoke/manifesto_desktop.png')
  ...
  await pageMob.screenshot({ path: '.smoke/manifesto_mobile.png', fullPage: true })
  console.log('Saved .smoke/manifesto_mobile.png')
