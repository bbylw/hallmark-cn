...
async function capture() {
  ...
  await pageDesk.screenshot({ path: '.smoke/newsprint_desktop.png', fullPage: true })
  console.log('Saved .smoke/newsprint_desktop.png')
  ...
  await pageMob.screenshot({ path: '.smoke/newsprint_mobile.png', fullPage: true })
  console.log('Saved .smoke/newsprint_mobile.png')
