...
async function capture() {
  ...
  await pageDesk.screenshot({ path: '.smoke/brutal_desktop.png', fullPage: true })
  console.log('Saved .smoke/brutal_desktop.png')
  ...
  await pageMob.screenshot({ path: '.smoke/brutal_mobile.png', fullPage: true })
  console.log('Saved .smoke/brutal_mobile.png')
