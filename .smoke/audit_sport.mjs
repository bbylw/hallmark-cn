...
async function runAudit() {
  console.log('🚀 Starting Audit for SportPage: ' + TARGET_URL)
  ...
  const min45Btn = page.locator('button:has-text("45 分钟")')
  await min45Btn.click()
  await page.waitForTimeout(150)

  const has75km = await page.locator('text=7.5 km').count()
