...
async function capture() {
  ...
  await pageDesk.screenshot({ path: '.smoke/aurora_desktop.png', fullPage: true })
  console.log('Saved .smoke/aurora_desktop.png')
  ...
  await pageMob.screenshot({ path: '.smoke/aurora_mobile.png', fullPage: true })
  console.log('Saved .smoke/aurora_mobile.png')
