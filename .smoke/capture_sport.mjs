...
const TARGET_URL = 'https://hallmark-cn.localhost/themes/sport'
...
async function capture() {
  ...
  await pageDesk.screenshot({ path: '.smoke/sport_desktop.png', fullPage: true })
  console.log('Saved .smoke/sport_desktop.png')
  ...
  await pageMob.screenshot({ path: '.smoke/sport_mobile.png', fullPage: true })
  console.log('Saved .smoke/sport_mobile.png')
